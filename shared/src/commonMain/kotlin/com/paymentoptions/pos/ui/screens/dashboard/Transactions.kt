...
fun Transactions(
    ...
    if (transactions.isEmpty()) NoData(text = "No transactions found")
        ...
        transactions.forEachIndexed { index, transaction ->
                ...
                if (!skip) {
                    val transactionDate = safeParseDateTime(transaction.Date).toLocalDateTime(TimeZone.currentSystemDefault())

                    if (transactionDate.dayOfMonth == today.dayOfMonth && transactionDate.monthNumber == today.monthNumber && transactionDate.year == today.year)

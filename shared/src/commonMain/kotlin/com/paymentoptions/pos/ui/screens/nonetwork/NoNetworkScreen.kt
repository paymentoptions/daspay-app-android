package com.paymentoptions.pos.ui.screens.nonetwork
...
import paymentoptionspos.shared.generated.resources.no_network
...
fun NoNetworkScreen() {
    SimpleLayout {
        Column(
            ...
            Text(
                text = stringResource(Res.string.no_network),
                color = Color.White,

...
val cappuccinoRegular = FoodItem(
    id = "2", name = "Cappuccino", size = Size.REGULAR, currency = "HKD", price = 3.8f,
    isVegetarian = true,
    category = "Beverage",
)

val cappuccinoMedium = FoodItem(
    id = "3", name = "Cappuccino", size = Size.MEDIUM, currency = "HKD", price = 5.8f,
    isVegetarian = false,
    category = "Beverage",
)

val cappuccinoLarge = FoodItem(
    id = "4", name = "Cappuccino", size = Size.LARGE, currency = "HKD", price = 8.0f,
    isVegetarian = false,
    category = "Beverage",
)
